      ...
      <div className="w-full max-w-5xl bg-[#13151A] rounded-2xl shadow-xl border border-gray-800 p-8 md:p-10 text-gray-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">College Email</label>
              <input value={alternativeEmail} onChange={(e) => setAlternativeEmail(e.target.value)} required className="w-full bg-[#0B0C10] border border-gray-700 rounded-md p-3 text-sm focus:outline-none focus:border-blue-500 transition-colors" type="email" />
            </div>

            {/* Row 2 */}
            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">College Name</label>
              <input value={collegeName} onChange={(e) => setCollegeName(toTitleCase(e.target.value))} required className="w-full bg-[#0B0C10] border border-gray-700 rounded-md p-3 text-sm focus:outline-none focus:border-blue-500 transition-colors" type="text" />
            </div>

            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Branch/Department</label>
              <input value={branch} onChange={(e) => setBranch(toTitleCase(e.target.value))} required className="w-full bg-[#0B0C10] border border-gray-700 rounded-md p-3 text-sm focus:outline-none focus:border-blue-500 transition-colors" type="text" />
            </div>

            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Year of Study</label>
              <select value={yearOfStudy} onChange={(e) => setYearOfStudy(e.target.value)} required className="w-full bg-[#0B0C10] border border-gray-700 rounded-md p-3 text-sm focus:outline-none focus:border-blue-500 transition-colors appearance-none">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <input value={counselor} onChange={(e) => setCounselor(toTitleCase(e.target.value))} required className="w-full bg-[#0B0C10] border border-gray-700 rounded-md p-3 text-sm focus:outline-none focus:border-blue-500 transition-colors" type="text" />
            </div>

            {/* Row 4 */}
            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-orange-500">Program Price (₹)</label>
              <input value={programPrice} onChange={(e) => setProgramPrice(e.target.value)} required className="w-full bg-[#0B0C10] border border-orange-500 rounded-md p-3 text-sm focus:outline-none focus:ring-1 focus:ring-orange-500 transition-colors" type="number" />
            </div>
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Select Opted Domain</label>
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Select Opted Month</label>
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Due date for clear payment ?</label>
              <input value={clearPaymentMonth} onChange={(e) => setClearPaymentMonth(e.target.value)} required className="w-full bg-[#0B0C10] border border-gray-700 rounded-md p-3 text-sm focus:outline-none focus:border-blue-500 transition-colors text-gray-400" type="date" />
            </div>
            
            {/* Row 7 */}
            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Internship starts month</label>
              <select value={internshipstartsmonth} onChange={(e) => setInternshipStartsMonth(e.target.value)} required className="w-full bg-[#0B0C10] border border-gray-700 rounded-md p-3 text-sm focus:outline-none focus:border-blue-500 transition-colors appearance-none">
            ...
            <div className="flex flex-col space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400">Internship ends month</label>
              <select value={internshipendsmonth} onChange={(e) => setInternshipEndsMonth(e.target.value)} required className="w-full bg-[#0B0C10] border border-gray-700 rounded-md p-3 text-sm focus:outline-none focus:border-blue-500 transition-colors appearance-none">
