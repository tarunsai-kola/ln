         ...
         <div className={`sticky-bar ${scrolled ? 'visible' : ''}`}>
            <div className="shell flex justify-between items-center w-full">
               ...
               <div className="flex gap-6 items-center">
                  <button onClick={() => window.location.href = 'tel:6374431801'} className="text-xs font-black uppercase hidden xl:flex items-center gap-2 hover:opacity-80 transition-all text-white"><PhoneCall size={14} /> Request Callback</button>
                  <ApplyNowButton
