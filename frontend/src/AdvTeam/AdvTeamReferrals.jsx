...
const AdvTeamReferrals = () => {
  ...
  const fetchReferrals = async (currentPage) => {
    setLoading(true);
    try {
      const response = await axios.get(`${API}/advreferrals`, {
        params: {
          page: currentPage,
          limit: 50,
  ...
  return (
    <div className="min-h-screen bg-slate-50 pl-[280px] pt-[70px]">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500 mt-2 font-medium">
              View referrals submitted by your students via the Dashboard Access form.
            </p>
          </div>
...
export default AdvTeamReferrals;
