...
// Use child_process to avoid PowerShell encoding issues
const gitOutput = execSync('git show HEAD:frontend/src/page/DataScience.jsx');
let content = gitOutput.toString('utf8');
...
content = content.replace(/import "\.\/DataScience\.css";/, 'import "../page/VLSI.css";'); 
...
console.log('PremiumCourseLayout.jsx successfully rebuilt with UTF-8!');
