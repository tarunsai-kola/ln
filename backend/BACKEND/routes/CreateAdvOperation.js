...
router.post("/sendmailtoadvoperation", async (req, res) => {
  try {
    ...
    const content = `
      ...
      <div style="text-align: center; margin: 30px 0;">
          <a href="https://www.Accenlearn.com/operationlogin" target="_blank" style="background-color: #4f46e5; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; display: inline-block;">Login to Dashboard</a>
      </div>
    `;
