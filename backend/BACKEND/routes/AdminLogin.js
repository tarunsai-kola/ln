...
router.post('/sendmailtooperation', async (req, res) => {
  ...
  const content = `
      ...
      <div style="text-align: center; margin: 35px 0;">
          <a href="https://www.Accenlearn.in/OperationLogin" target="_blank" class="cta-button">Access Your Portal</a>
      </div>
...
router.post('/sendmailtobda', async (req, res) => {
  ...
  const content = `
      ...
      <div style="text-align: center; margin: 35px 0;">
          <a href="https://www.Accenlearn.in/employLogin" target="_blank" class="cta-button">Access Your Portal</a>
      </div>
...
router.post('/sendmailtoadvteam', async (req, res) => {
  ...
  const content = `
      ...
      <div style="text-align: center; margin: 35px 0;">
          <a href="https://www.Accenlearn.com/employlogin" target="_blank" class="cta-button">Access Your Portal</a>
      </div>
