...
const Workshop2 = ({ title = "Technical Domains" }) => {
  ...
  const pillars = [
    ...
    },
    {
      ...
      description:
        "Benefit from personalized mentorship, networking opportunities, and job placement assistance to fast-track your career growth.",
    },
  ];
  ...
  return (
    <div className="min-h-screen w-full pt-4 sm:pt-6 pb-16">
      <div className="mx-auto px-4">
        ...
        <section className="mt-12">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {highlightStats.map((item, idx) => (
              <div key={idx} className="rounded-2xl shadow-md border border-gray-100 p-6 text-center">
                <div className="text-3xl md:text-4xl font-extrabold text-secondary mb-2">{item.value}</div>
        ...
        <section className="mt-12">
          <TitleText align="left" title="IBM Certification Path" description="Why and how to get certified." />
          <div className="grid gap-6 md:grid-cols-3">
            <div className="md:col-span-2 rounded-2xl border border-gray-100 shadow-md p-6 space-y-4">
              <p className="text-lg font-semibold text-primary">Why Should You Get Certified?</p>
              ...
              <div className="flex flex-col gap-2 text-sm font-semibold">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-secondary">1 hour</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Mode:</span>
            ...
            <div className="rounded-2xl bg-primary text-white shadow-md p-6 space-y-3">
              ...
              <img src={IMAGE_HELPER?.IBM} alt="IBM Certificate" className="w-full h-full object-contain rounded-2xl" />
            </div>
          </div>
        </section>
