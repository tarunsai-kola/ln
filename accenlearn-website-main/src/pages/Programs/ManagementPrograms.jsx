...
const MANAGEMENT_COURSES = [
  {
    ...
    description: "Master SEO, SEM, content marketing, and digital brand strategy.",
    rating: "4.9",
    duration: "4 Months",
    bullets: ["SEO & SEM Strategies", "Social Media Marketing", "Campaign Analytics"],
    roles: "Digital Marketer, SEO Specialist",
    icons: [<FaBriefcase key="1" />],
    color: "blue",
  ...
  },
  {
    ...
    description: "Learn talent acquisition, employee relations, and organizational development.",
    rating: "4.8",
    duration: "3 Months",
    bullets: ["Talent Acquisition", "Employee Engagement", "HR Analytics"],
    roles: "HR Executive, Talent Partner",
    icons: [<FaStar key="1" />],
    color: "emerald",
  ...
  },
  {
    ...
    description: "Deep dive into financial modeling, analysis, and corporate finance.",
    rating: "4.9",
    duration: "6 Months",
    bullets: ["Financial Modeling", "Corporate Finance", "Investment Analysis"],
    roles: "Financial Analyst, Advisor",
    ...
    span: "md:col-span-1",
    image: "/program-bg/ai-fsd.png"
  },
  {
    title: "Business Analytics",
    path: "/programs/management/business-analytics",
    description: "Transform data into strategic business decisions and insights.",
    rating: "4.8",
    duration: "5 Months",
    bullets: ["Data Visualization", "Strategic Planning", "Predictive Analytics"],
  ...
  },
  {
    ...
    description: "Master trading strategies, technical analysis, and portfolio management.",
    rating: "4.7",
    duration: "3 Months",
    bullets: ["Technical Analysis", "Options Trading", "Risk Management"],
  ...
  },
  {
    ...
    description: "Create stunning visual content, branding, and digital media.",
    rating: "4.9",
    duration: "4 Months",
    bullets: ["Adobe Creative Suite", "Brand Identity", "UI/UX Basics"],
    roles: "Graphic Designer, Creative Lead",
    icons: [<FaStar key="1" />],
    color: "fuchsia",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto lg:mx-0 mb-12 leading-relaxed font-light">
                An executive-tier program designed to break you into product-based companies. Learn real-world engineering and data science directly from industry veterans.
              </p>
      ...
      <div className="bg-[#0a0a0f] relative overflow-hidden py-24">
        ...
        <div className="relative max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 auto-rows-min">
            {MANAGEMENT_COURSES.map((course, idx) => (
              <div 
                key={idx} 
